...
class SignUp(BasePage):
    ...
    @allure.step('Проверить URL регистрации')
    ...
    @allure.step('Проверить URL регистрации (окно с Telegram)')
    ...
    @allure.step('Проверить, что кнопка регистрации через Telegram видна')
